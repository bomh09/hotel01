...
?>
<section class="home-blogs-section animate" data-anim-type="fadeInLeft" data-anim-delay="800" style="background:url('<?php echo ($hotel_galaxy_settings['blog_section_bg'])? $hotel_galaxy_settings['blog_section_bg'] :''; ?>') no-repeat fixed 0 0 / cover  #000000;">
	
	<div id="blogs" class="overlay colut-news-overlay" style="padding-top: 60px;padding-bottom: 85px;background: rgba(0,0,0,0.8);">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
