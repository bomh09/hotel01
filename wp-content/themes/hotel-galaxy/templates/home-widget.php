...
<section id="services" class="feature-section animate" data-anim-type="fadeInLeft" data-anim-delay="800" style="padding-top: 20px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
		...
		<div class="row">
			<div class="owl-carousel owl-theme owl-services">
				...
				if ( is_active_sidebar( 'home-services' ) ) {
					...
					?>
					<div class=" animate zoomIn" data-anim-type="zoomIn" data-anim-delay="200">
