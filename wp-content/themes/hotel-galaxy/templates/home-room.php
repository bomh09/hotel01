...
<section id="rooms" class="feature-section home-room-sec animate" data-anim-type="fadeInLeft" data-anim-delay="800" style="background: <?php echo esc_attr($hotel_galaxy_settings['room_sec_bgColor']) ?>; padding-top: 20px">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
