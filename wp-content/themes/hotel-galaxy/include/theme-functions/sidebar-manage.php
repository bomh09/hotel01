...
function hotel_galaxy_widgets_init() {
	...
	register_sidebar( array(
		'name' => __( 'Home Rooms', 'hotel-galaxy' ),
		'id' => 'home-rooms',
		'description' => __( 'Hotel galaxy Rooms area', 'hotel-galaxy' ),
		'before_widget' => '',
		'after_widget' => '',
		'before_title' => '',
		'after_title' => ''
	...
	register_sidebar( array(
		...
		'before_widget' => '<div class="col-md-3 col-sm-6 col-xs-12 clearfix"><div class="footer-widget">',
