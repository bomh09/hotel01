...
<head>	
	...
	?>	
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() ?>/js/owlcarousel/assets/owl.carousel.min.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() ?>/js/owlcarousel/assets/owl.carousel.css">
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri() ?>/js/owlcarousel/assets/owl.theme.default.min.css">
	<script src="<?php echo get_stylesheet_directory_uri() ?>/js/jquery.min.js"></script>
    <script src="<?php echo get_stylesheet_directory_uri() ?>/js/owlcarousel/owl.carousel.min.js"></script>
				...
				<div class="row" style="height:35px;">
					<div class="col-md-8 col-sm-8 hidden-xs">
						<ul class="contact-top animate fadeInLeft" style="padding:0;">
							<?php if($option['address']!=''){?><li><strong><?php  _e('Địa chỉ:  ','hotel-galaxy'); ?></strong><?php echo esc_attr($option['address']); ?></li><?php } ?>
							<?php if($option['reservation_line']!=''){?><li><strong><?php _e('SĐT đặt phòng:  ','hotel-galaxy'); ?></strong><?php echo esc_attr($option['reservation_line']); ?></li><?php } ?>
						</ul>
					</div>
